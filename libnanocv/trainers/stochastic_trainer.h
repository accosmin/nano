...
namespace ncv
{
        ...
        ///
        /// parameters:
        ///     opt=sg[,sga,sia,nag,adagrad,adadelta]   - optimization method: SG, SGA, SIA, NAG, ADAGRAD, ADADELTA
        ...
        public:
                ...
                NANOCV_MAKE_CLONABLE(stochastic_trainer_t,
                                     "parameters: opt=sg[,sga,sia,nag,adagrad,adadelta],epoch=16[1,1024]")
