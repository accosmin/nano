#include "minimize.h"
#include "liboptimize/batch_gd.hpp"
#include "liboptimize/batch_cgd.hpp"
#include "liboptimize/batch_lbfgs.hpp"
#include "liboptimize/stoch_ag.hpp"
#include "liboptimize/stoch_sg.hpp"
#include "liboptimize/stoch_sga.hpp"
...
namespace ncv
{
                ...
                size_t history_size)
        {
                ...
                case batch_optimizer::CGD_DYCD:
                        return  optimize::batch_cgd_dycd_t<opt_problem_t>
                                (iterations, epsilon, lsinit, lsstrat, fn_wlog, fn_elog, fn_ulog)
                                (problem, x0);
