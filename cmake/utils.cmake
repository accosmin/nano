...
macro(to_parent)
        ...
        set(CTEST_MEMORYCHECK_COMMAND_OPTIONS ${CTEST_MEMORYCHECK_COMMAND_OPTIONS} PARENT_SCOPE)
endmacro()
...
function(setup_asan)
        ...
        if_flag("-fsanitize=address" CMAKE_EXE_LINKER_FLAGS)
        to_parent()
endfunction()
...
function(setup_usan)
        ...
        if_flag("-fno-omit-frame-pointer" CMAKE_CXX_FLAGS)
        if_flag("-fno-optimize-sibling-calls" CMAKE_CXX_FLAGS)
        if_flag("-fsanitize=undefined" CMAKE_EXE_LINKER_FLAGS)
        to_parent()
endfunction()
...
function(setup_lsan)
        ...
        if_flag("-fno-omit-frame-pointer" CMAKE_CXX_FLAGS)
        if_flag("-fno-optimize-sibling-calls" CMAKE_CXX_FLAGS)
        if_flag("-fsanitize=leak" CMAKE_EXE_LINKER_FLAGS)
        to_parent()
endfunction()
...
function(setup_tsan)
        ...
        if_flag("-fsanitize=thread" CMAKE_EXE_LINKER_FLAGS)
        to_parent()
endfunction()
...
function(setup_msan)
        ...
        if_flag("-fsanitize=memory" CMAKE_EXE_LINKER_FLAGS)
        to_parent()
endfunction()
...
function(setup_valgrind)
        ...
        set(CTEST_MEMORYCHECK_COMMAND_OPTIONS "${CTEST_MEMORYCHECK_COMMAND_OPTIONS} --track-fds=yes")
        set(CTEST_MEMORYCHECK_COMMAND_OPTIONS "${CTEST_MEMORYCHECK_COMMAND_OPTIONS} --track-origins=yes")
        set(CTEST_MEMORYCHECK_COMMAND_OPTIONS "${CTEST_MEMORYCHECK_COMMAND_OPTIONS} --trace-children=yes")
        set(CTEST_MEMORYCHECK_COMMAND_OPTIONS "${CTEST_MEMORYCHECK_COMMAND_OPTIONS} --error-exitcode=1")
        to_parent()
endfunction()
...
function(setup_coverage)
        ...
        if_flag("-fno-inline" CMAKE_CXX_FLAGS)
