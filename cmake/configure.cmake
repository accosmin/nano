...
set(ZOB_TEST_PROGRAM "int main() { return 0; }")
...
CHECK_CXX_SOURCE_COMPILES("${ZOB_TEST_PROGRAM}" COMPILER_SUPPORTS_SANITIZE_ADDRESS)

set(CMAKE_REQUIRED_FLAGS "-fsanitize=undefined")
CHECK_CXX_SOURCE_COMPILES("${ZOB_TEST_PROGRAM}" COMPILER_SUPPORTS_SANITIZE_UNDEFINED)

set(CMAKE_REQUIRED_FLAGS "-fsanitize=vptr")
CHECK_CXX_SOURCE_COMPILES("${ZOB_TEST_PROGRAM}" COMPILER_SUPPORTS_SANITIZE_VPTR)

set(CMAKE_REQUIRED_FLAGS "-fsanitize=leak")
CHECK_CXX_SOURCE_COMPILES("${ZOB_TEST_PROGRAM}" COMPILER_SUPPORTS_SANITIZE_LEAK)

set(CMAKE_REQUIRED_FLAGS "-fsanitize=integer")
CHECK_CXX_SOURCE_COMPILES("${ZOB_TEST_PROGRAM}" COMPILER_SUPPORTS_SANITIZE_INTEGER)

set(CMAKE_REQUIRED_FLAGS "-fsanitize=thread")
CHECK_CXX_SOURCE_COMPILES("${ZOB_TEST_PROGRAM}" COMPILER_SUPPORTS_SANITIZE_THREAD)

set(CMAKE_REQUIRED_FLAGS "-fsanitize=memory")
CHECK_CXX_SOURCE_COMPILES("${ZOB_TEST_PROGRAM}" COMPILER_SUPPORTS_SANITIZE_MEMORY)
