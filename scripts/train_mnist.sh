...
mbatch_gd="--trainer minibatch --trainer-params opt=gd,epoch=16,batch=1024,iters=8,eps=1e-6"
...
do
        ...
        fn_train_callgrind ${dir_exp_mnist} mlp0_${trainer} ${params} ${!trainer} ${mlp0}${outlayer}
