...
model1=${model0}"conv:count=32,rows=8,cols=8;snorm;smax-abs-pool;"
model1=${model1}"conv:count=32,rows=6,cols=6;snorm;"

model2=${model0}"conv:count=32,rows=6,cols=6;snorm;smax-abs-pool;"
model2=${model2}"conv:count=32,rows=4,cols=4;snorm;smax-abs-pool;"
model2=${model2}"conv:count=32,rows=2,cols=2;snorm;"
