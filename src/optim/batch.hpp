...
namespace nano
{
                ...
                const std::size_t history_size = 6)
        {
                ...
                switch (optimizer)
                {
                case batch_optimizer::GD:               return batch_gd_t()(param, problem, x0);

                case batch_optimizer::CGD:              return batch_cgd_prp_t()(param, problem, x0);
                case batch_optimizer::CGD_N:            return batch_cgd_n_t()(param, problem, x0);
                case batch_optimizer::CGD_CD:           return batch_cgd_cd_t()(param, problem, x0);
                case batch_optimizer::CGD_DY:           return batch_cgd_dy_t()(param, problem, x0);
                case batch_optimizer::CGD_FR:           return batch_cgd_fr_t()(param, problem, x0);
                case batch_optimizer::CGD_HS:           return batch_cgd_hs_t()(param, problem, x0);
                case batch_optimizer::CGD_LS:           return batch_cgd_ls_t()(param, problem, x0);
                case batch_optimizer::CGD_PRP:          return batch_cgd_prp_t()(param, problem, x0);
                case batch_optimizer::CGD_DYCD:         return batch_cgd_dycd_t()(param, problem, x0);
                case batch_optimizer::CGD_DYHS:         return batch_cgd_dyhs_t()(param, problem, x0);

                case batch_optimizer::LBFGS:
                default:                                return batch_lbfgs_t()(param, problem, x0);
                }
        }
