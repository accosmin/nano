...
namespace nano
{
        ...
        bool ls_strategy_t::operator()(const function_t& function, const scalar_t t0, state_t& state) const
        {
        ...
        bool ls_strategy_t::setup(const function_t& function, const ls_step_t& step0, const ls_step_t& step, state_t& state) const
        {
                return step && step < step0 && setup(function, step, state);
        }

        bool ls_strategy_t::setup(const function_t& function, const ls_step_t& step, state_t& state) const
        {
