...
namespace nano
{
        ...
        protected:
                ...
                virtual scalar_t error(const vector_map_t& targets, const vector_map_t& scores) const = 0;
                virtual scalar_t value(const vector_map_t& targets, const vector_map_t& scores) const = 0;
                virtual void vgrad(const vector_map_t& targets, const vector_map_t& scores, vector_map_t&) const = 0;
        };
}
