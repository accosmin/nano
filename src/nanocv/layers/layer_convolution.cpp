...
namespace ncv
{
	...
	/////////////////////////////////////////////////////////////////////////////////////////
        ...
        scalar_t conv_layer_t::forward_mflops() const
        {
                return 1e-6 * (odims() * idims() * orows() * ocols() * krows() * kcols());
        }

        /////////////////////////////////////////////////////////////////////////////////////////

        scalar_t conv_layer_t::backward_mflops() const
        {
                return 1e-6 * (odims() * idims() * orows() * ocols() * krows() * kcols() * 2);
        }
