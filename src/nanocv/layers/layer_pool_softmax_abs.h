#ifndef NANOCV_POOL_SOFTMAX_ABS_LAYER_H
#define NANOCV_POOL_SOFTMAX_ABS_LAYER_H
...
namespace ncv
{
        ...
        ///
        class pool_softmax_abs_layer_t : public layer_t
        {
        public:

                // constructor
                pool_softmax_abs_layer_t(const string_t& parameters = string_t())
                ...
                {
                        return rlayer_t(new pool_softmax_abs_layer_t(parameters));
                }
...
#endif // NANOCV_POOL_SOFTMAX_ABS_LAYER_H
