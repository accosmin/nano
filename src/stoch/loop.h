...
namespace nano
{
        ...
        {
                return make_finite_space(scalar_t(1e-2), scalar_t(1e-1), scalar_t(1e+0));
        }

        inline auto make_decays()
        {
                return make_finite_space(scalar_t(0.00), scalar_t(0.10), scalar_t(0.20), scalar_t(0.50), scalar_t(0.75), scalar_t(1.00));
        }
