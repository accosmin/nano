...
bool nano::load_rgba_image(const string_t& path, image_tensor_t& image)
{
        return load_image(path, color_mode::rgba, image);
}

bool nano::load_luma_image(const string_t& path, image_tensor_t& image)
{
        return load_image(path, color_mode::luma, image);
}

bool nano::load_rgb_image(const string_t& path, image_tensor_t& image)
{
        return load_image(path, color_mode::rgb, image);
}

bool nano::load_rgba_image(const string_t& name, const char* buffer, const size_t buffer_size, image_tensor_t& image)
{
        return load_image(name, buffer, buffer_size, color_mode::rgba, image);
}

bool nano::load_luma_image(const string_t& name, const char* buffer, const size_t buffer_size, image_tensor_t& image)
{
        return load_image(name, buffer, buffer_size, color_mode::luma, image);
}

bool nano::load_rgb_image(const string_t& name, const char* buffer, const size_t buffer_size, image_tensor_t& image)
{
