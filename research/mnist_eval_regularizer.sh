...
conv1=${conv0}"conv-k2d:dims=16,rows=9,cols=9,conn=1;act-snorm;"
conv2=${conv1}"conv-k2d:dims=32,rows=7,cols=7,conn=2;act-snorm;"
conv3=${conv2}"conv-k2d:dims=64,rows=5,cols=5,conn=4;act-snorm;"
conv4=${conv3}"conv-k2d:dims=128,rows=3,cols=3,conn=8;act-snorm;"
...
models=""
models=${models}" mlp0 mlp1 mlp2 mlp3"
